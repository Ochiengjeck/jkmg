...
class EventRegistration {
  ...
  factory EventRegistration.fromJson(Map<String, dynamic>? json) {
    ...
    return EventRegistration(
      id: json['id'] as int? ?? 0,
      event: json['event'] != null ? Event.fromJson(json['event'] as Map<String, dynamic>) : Event.empty(),
      attendance: json['attendance'] != null 
          ? TypeValue.fromJson(json['attendance'] as Map<String, dynamic>) 
          : TypeValue.empty(),
      volunteer: json['volunteer'] as bool? ?? false,
      registeredAt: json['registered_at'] as String? ?? DateTime.now().toIso8601String(),
    );
  }
