      ...
      child: Column(
        ...
        children: [
          ...
          _buildSocialMediaCard(
            'YouTube',
            'Watch our sermons, teachings, and events',
            Icons.video_library,
            Colors.red,
            'youtube.com/c/RevJulianKyula',
            () => _launchUrl('https://youtube.com/c/RevJulianKyula'),
          ),
          _buildSocialMediaCard(
            'Facebook',
            ...
            Icons.facebook,
            Colors.blue,
            'facebook.com/JulianKyulaMinistries',
            () => _launchUrl('https://facebook.com/JulianKyulaMinistries'),
          ),
          _buildSocialMediaCard(
            'Instagram',
            ...
            Colors.purple,
            '@RevJulianKyula',
            () => _launchUrl('https://instagram.com/RevJulianKyula'),
          ),
          _buildSocialMediaCard(
            'Twitter/X',
            'Latest updates and spiritual insights',
            Icons.alternate_email,
            Colors.black,
            '@RevJulianKyula',
            () => _launchUrl('https://x.com/RevJulianKyula'),
          ),
          const SizedBox(height: 24),
