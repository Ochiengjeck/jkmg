...
final List<OnboardingData> onboardingData = [
  OnboardingData(
    ...
    particles: [
      ...
      ParticleData(Icons.menu_book, const Offset(0.8, 0.1), 1.5),
      ParticleData(Icons.auto_awesome, const Offset(0.2, 0.7), 1.8),
  ...
  OnboardingData(
    ...
    particles: [
      ParticleData(Icons.access_time, const Offset(0.15, 0.3), 1.8),
      ParticleData(Icons.nights_stay, const Offset(0.7, 0.2), 2.1),
      ParticleData(Icons.favorite, const Offset(0.3, 0.8), 1.6),
      ParticleData(Icons.spa, const Offset(0.85, 0.7), 1.9),
    ],
  ),
  OnboardingData(
    ...
    particles: [
      ParticleData(Icons.lightbulb_outline, const Offset(0.1, 0.25), 2.0),
      ParticleData(Icons.menu_book, const Offset(0.8, 0.15), 1.7),
      ParticleData(Icons.favorite, const Offset(0.25, 0.75), 1.9),
      ParticleData(Icons.psychology, const Offset(0.9, 0.65), 2.3),
    ],
  ),
  OnboardingData(
    title: "Global Events",
    ...
    particles: [
      ParticleData(Icons.event, const Offset(0.12, 0.28), 1.8),
      ParticleData(Icons.celebration, const Offset(0.75, 0.18), 2.0),
      ParticleData(Icons.groups, const Offset(0.2, 0.72), 1.6),
      ParticleData(Icons.public, const Offset(0.88, 0.68), 2.1),
    ],
  ),
];
